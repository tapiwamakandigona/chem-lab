...
- 🎓 **17-unit guided course** with progress tracking (stored locally, no account)
...
python tests/run_gates.py   # full 26-gate Playwright regression
```
